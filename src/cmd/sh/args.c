...
char flagchar[] = { 'x', 'n', 'v', 't', STDFLG, 'i', 'e', 'r', 'k', 'u', 'h', 'f', 'a', 0 };

long flagval[] = { execpr, noexec, readpr, oneflg,  stdflg,   intflg,    errflg,
                   rshflg, keyflg, setflg, hashflg, nofngflg, exportflg, 0 };
...
struct dolnod *clean_args(struct dolnod *blk)
{
    register char **argp;
    register struct dolnod *argr = NIL;
    register struct dolnod *argblk;
