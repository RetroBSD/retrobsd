...
/*
 * mode(n)
 *  3: save old tty stat, set raw mode with INPPUT flow control
 *  2: set OUTPUT XON/XOFF for sb/sz with ZMODEM or YMODEM-g
 *  1: save old tty stat, set raw mode for XMODEM/YMODEM
