...
void ethernet_init()
{
    ...
    printf("local MAC address %02x:%02x:%02x:%02x:%02x:%02x\n", ethernet_mac[0], ethernet_mac[1],
           ethernet_mac[2], ethernet_mac[3], ethernet_mac[4], ethernet_mac[5]);
    printf("local IP address %u.%u.%u.%u\n", ethernet_ip[0], ethernet_ip[1], ethernet_ip[2],
           ethernet_ip[3]);
    printf("gateway %u.%u.%u.%u\n", ethernet_gateway[0], ethernet_gateway[1], ethernet_gateway[2],
           ethernet_gateway[3]);
    printf("netmask %u.%u.%u.%u\n", ethernet_netmask[0], ethernet_netmask[1], ethernet_netmask[2],
           ethernet_netmask[3]);
